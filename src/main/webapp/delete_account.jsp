	...
	<div class="container-fullwidth">
		...
		<div class="row" style="margin-top: 50px;">
			<div class="col-md-4 col-md-offset-4">
				<form form action="${pageContext.request.contextPath}/delete_account" method="post">
					...
					<div class="col-sm-8 form-group">
						<input type="text" value="<%=user.getEmail() %>" required placeholder="Enter Account No.."
							class="form-control">
					</div>
					<label class="col-md-4 control-label">User Name</label>
					<div class="col-sm-8 form-group">
						<input type="text" value="<%=user.getFirstName() %>" required placeholder="Enter User Name.."
							class="form-control">
					</div>
